...
public sealed class AttachmentService(HttpClient http) : IDisposable
{
    ...
    {
        public LocalAttachment ToLocalAttachment(bool leaveOpen = false) => new(Stream, FileName, leaveOpen);
        
        void IDisposable.Dispose() => Stream.Dispose();
        
        public static implicit operator LocalAttachment(Attachment attachment) => attachment.ToLocalAttachment();
